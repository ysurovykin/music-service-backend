...
import SongModel, { SongRecordType } from '../song/song.model';
...
import SongRadioModel, {
    ...
    SongRadioRecordType
} from './songRadio.model';
import {
    mainSampleSizeMultiplier,
    mainArtistSampleSizeMultiplier,
    coArtistSampleSizeMultiplier,
    secondarySampleSizeMultiplier,
    freeSubscriptionSongRadioLimit, 
    paidSubscriptionSongRadioLimit
} from '../../../config';
