...
import ArtistModel, { ArtistInfoResponseDataType, ArtistShortDataType } from '../artist/artist.model';
import AlbumModel, { AlbumInfoResponseDataType } from '../album/album.model';
import AlbumDto from '../album/album.dto';
import PlaylistModel, { PlaylistTagEnum } from '../playlist/playlist.model';
...
import FollowedArtistsModel from '../artist/followedArtists.model';
...
class ListenerService {
    ...
    async getRecentMostVisitedContent(listenerId: string): Promise<Array<ContentDataType>> {
        ...
        if (listener.recentMostVisitedContent?.length) {
            let mostVisitedContent: Array<ContentDataType> = [];
            for (let place of listener.recentMostVisitedContent) {
